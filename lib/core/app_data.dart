...
class AppData {
  ...
  static const List<Food> foodItems = [
    Food(
        id: 1,
  ...
  static const List<BottomNavigationItem> bottomNavigationItems = [
     BottomNavigationItem(
        Icon(Icons.home_outlined), Icon(Icons.home), 'Home',
        isSelected: true),
    BottomNavigationItem( Icon(Icons.shopping_cart_outlined),
         Icon(Icons.shopping_cart), 'Shopping cart'),
    BottomNavigationItem( Icon(AppIcon.outlinedHeart),
         Icon(AppIcon.heart), 'Favorite'),
    BottomNavigationItem(
